...
<head>
  ...
  <title> Add Freelancer profile</title>
</head>
<body>
<div class="container">	
<div class="row">
     ...
     <div class="col-md-6">
    <center><h1>TAMBAH DATA PROFIL FREELANCER</h1></center>
   <form action="/profilfreelancer/save" method="post">
        ...
        <div class="form-group">
        <p>Skill : <input type="text" class="form-control" name ="skill"></p>
        </div>
        <div class="form-group">
        <p>Phone Number : <input type="number" class="form-control" name ="phone_number"></p>
        </div>
